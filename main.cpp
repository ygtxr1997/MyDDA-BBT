...
//DWORD WINAPI DDAProc(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ INT nCmdShow);
//
//
////
//// 等待队列
...
//			{
//				Ret = OutMgr.UpdateApplicationWindow(ThreadMgr.GetPointerInfo(), &Occluded, &bitmapAlloc, &bitmapSize, &bitmapPitch);	//ADD: bitmapAlloc, bitmapSize
//			}
//		}
//	} // 一次消息循环结束
//
